    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xs-6 col-md-6 col-lg-6">
                ...
                <button class="btn btn-dark" type="button" ><a class='post'href="nuevo.php">Nuevo Post</a></button>
                <button class="btn btn-dark" type="button" ><a class='post'href="cerrar.php">Cerrar Sesion</a></button><br></br>
                <?php foreach ($posts as $post) : ?>

                    <div class="card mb-3">
                        <!--<img src='' class="card-img-top" alt="...">-->
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $post['id'] . " - " . $post['titulo']; ?></h5>
