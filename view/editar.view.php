            ...
            <div class="col-xs-6 col-md-6 col-lg-6">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" class="form-control" value="" value="<?php echo $post['id']?>" aria-label="First name" name="id"> 
                        <div class="row justify-content-center">
                                ...
                                <div class="col-xs-3 col-md-6 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $post['titulo']?>" aria-label="First name" name="titulo"></br>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-xs-3 col-md-6 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $post['extracto']?>" aria-label="Last name" name="extracto"></br>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-xs-3 col-md-6 col-lg-6">
                                    ...
                                    <textarea type="text" class="form-control"  aria-label="Biografia" name="texto"><?php echo $post['texto']?></textarea></br>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-xs-3 col-md-6 col-lg-6">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="thumb-guardada" value="<?php echo $post['thumb']?>" aria-label="First name" name="thumb-guardada"> 
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-xs-3 col-md-6 col-lg-6">

                                    <input type="submit" class="btn btn-primary" name="editar" value="Modificar articulo">
